...
export const SNAP_TOLERANCE = 64; // Increased for even easier magnetic snapping
...
export const DRAG_VISUAL_OFFSET = 0; 
...
export const LATCH_POINTS: LatchPoint[] = [
  ...
  { id: 'bottom', x: 0.5, y: 1, color: 'bg-rose-500', pair: 'top', axis: 'vertical', type: 'flow' }, 
  { id: 'right', x: 1, y: 0.5, color: 'bg-emerald-500', pair: 'left', axis: 'horizontal', type: 'flow' },           
  { id: 'left', x: 0, y: 0.5, color: 'bg-fuchsia-500', pair: 'right', axis: 'horizontal', type: 'peek' } 
];
